...
<Project Type="Project" LVVersion="15008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Google Earth" Type="Folder">
			<Item Name="FindWindowA.vi" Type="VI" URL="../Google Earth/FindWindowA.vi"/>
			<Item Name="GE hWnd Handler.vi" Type="VI" URL="../Google Earth/GE hWnd Handler.vi"/>
			<Item Name="Google Earth - initialise.vi" Type="VI" URL="../Google Earth/Google Earth - initialise.vi"/>
			<Item Name="Google Earth - Version info.vi" Type="VI" URL="../Google Earth/Google Earth - Version info.vi"/>
			<Item Name="IKHinterface - initialize.vi" Type="VI" URL="../Google Earth/IKHinterface - initialize.vi"/>
			<Item Name="SetParent.vi" Type="VI" URL="../Google Earth/SetParent.vi"/>
			<Item Name="UpdateGEKML.vi" Type="VI" URL="../Google Earth/UpdateGEKML.vi"/>
			<Item Name="Write-out Google Maps.vi" Type="VI" URL="../Maps/Write-out Google Maps.vi"/>
			<Item Name="WriteKML.vi" Type="VI" URL="../Google Earth/WriteKML.vi"/>
		</Item>
		<Item Name="GPS" Type="Folder">
			<Item Name="CurrentLocation.vi" Type="VI" URL="../Path/CurrentLocation.vi"/>
			<Item Name="GPS NMEA Main Processor (SubVI).vi" Type="VI" URL="../Maps/GPS NMEA Main Processor (SubVI).vi"/>
			<Item Name="LatLongEmpty" Type="VI" URL="../Path/LatLongEmpty"/>
			<Item Name="NMEA_ParseMessage-GPGGA.vi" Type="VI" URL="../Maps/NMEA_ParseMessage-GPGGA.vi"/>
			<Item Name="ParseKML.vi" Type="VI" URL="../Maps/ParseKML.vi"/>
		</Item>
		<Item Name="Maps" Type="Folder">
			<Item Name="Create Map URL.vi" Type="VI" URL="../Maps/Create Map URL.vi"/>
			<Item Name="Create Path URL.vi" Type="VI" URL="/C/Users/Administrator/Downloads/Google Maps_LV2012_NI Verified/Google Maps_LV2012_NI Verified/SubVIs/Create Path URL.vi"/>
			<Item Name="Marker.vi" Type="VI" URL="/C/Users/Administrator/Downloads/Google Maps_LV2012_NI Verified/Google Maps_LV2012_NI Verified/SubVIs/Marker.vi"/>
			<Item Name="New Marker.vi" Type="VI" URL="/C/Users/Administrator/Downloads/Google Maps_LV2012_NI Verified/Google Maps_LV2012_NI Verified/SubVIs/New Marker.vi"/>
			<Item Name="States.ctl" Type="VI" URL="/C/Users/Administrator/Downloads/Google Maps_LV2012_NI Verified/Google Maps_LV2012_NI Verified/SubVIs/States.ctl"/>
		</Item>
		<Item Name="Path" Type="Folder">
			<Item Name="New Path.ctl" Type="VI" URL="../Custom Controls/New Path.ctl"/>
			<Item Name="NewPath.vi" Type="VI" URL="../Path/NewPath.vi"/>
		</Item>
		...
		<Item Name="Steering" Type="Folder">
			<Item Name="Actuator Base Code.vi" Type="VI" URL="../Actuator/Actuator Base Code.vi"/>
			<Item Name="calcTime.vi" Type="VI" URL="../Actuator/calcTime.vi"/>
			<Item Name="checkTime.vi" Type="VI" URL="../Actuator/checkTime.vi"/>
			<Item Name="ComputeSteeringAngle.vi" Type="VI" URL="../ComputeSteeringAngle.vi"/>
			<Item Name="SetSteeringAngle.vi" Type="VI" URL="../Actuator/SetSteeringAngle.vi"/>
			<Item Name="updateTime.vi" Type="VI" URL="../Actuator/updateTime.vi"/>
		</Item>
		...
		<Item Name="Type Definitions" Type="Folder">
			<Item Name="Compass.ctl" Type="VI" URL="../Custom Controls/Compass.ctl"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="CheckLocation.vi" Type="VI" URL="../Path/CheckLocation.vi"/>
			<Item Name="config.ctl" Type="VI" URL="../Custom Controls/config.ctl"/>
			<Item Name="convertLatLong.vi" Type="VI" URL="../Path/convertLatLong.vi"/>
			<Item Name="GPS_SignCardinalDirection (SubVI).vi" Type="VI" URL="/C/Users/rjr5357/Downloads/GPS_gather/GPS Example Contest/SubVI/GPS_SignCardinalDirection (SubVI).vi"/>
			<Item Name="kernel32.dll" Type="Document" URL="kernel32.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="LATLONG to bearing.vi" Type="VI" URL="../Steering/LATLONG to bearing.vi"/>
			<Item Name="LatLongUpperLowerBounds.vi" Type="VI" URL="../Path/LatLongUpperLowerBounds.vi"/>
			<Item Name="LatLongUpperLowerBoundsLASTPOINT.vi" Type="VI" URL="../Path/LatLongUpperLowerBoundsLASTPOINT.vi"/>
			...
			<Item Name="NMEA.lvlib" Type="Library" URL="/C/Users/rjr5357/Downloads/NMEA_v1.0 - LV2009/NMEA_v1.0 - LV2009/NMEA.lvlib"/>
